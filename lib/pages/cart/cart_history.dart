...
class CartHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget timeWidget(int index){
      ...
      return BigText(text: outputDate, size: Dimensions.font20);
    }
        ...
        children: [
            ...
            GetBuilder<CartController>(builder: (_cartController){
                                    ...
                                    Wrap(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          BigText(text: itemsPerOrder[i].toString() + " Items", color: AppColors.titleColor, size: Dimensions.font16,),
                                          GestureDetector(
                                            onTap: (){
                                            ...
                                            child: Container(
                                              padding: EdgeInsets.symmetric(horizontal: /*2*/Dimensions.width10, vertical: /*2*/Dimensions.height10/2, ),
                                              decoration: BoxDecoration(
             ...
             SizedBox(
                 ...
                 child: const NoDataPage(text: "You didn't buy anything still..!"));
            })
        ],
      ),
    );
